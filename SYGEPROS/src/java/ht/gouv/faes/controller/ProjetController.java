...
public class ProjetController implements Serializable {
    ...
    private Projet current;
    private DataModel items = null;
    @EJB
    private ht.gouv.faes.session.ProjetFacade ejbFacade;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ProjetDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Projet getProjet(java.lang.Integer id) {
    ...
    public static class ProjetControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Projet) {
                ...
                return getStringKey(o.getIdprojet());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Projet.class.getName());
            }
        }
