...
import ht.gouv.faes.session.DistributeurFacade;
...
public class DistributeurController implements Serializable {
    ...
    @EJB
    private ht.gouv.faes.session.DistributeurFacade ejbFacade;
    ...
    public Distributeur getDistributeur(java.lang.Integer id) {
    ...
    public static class DistributeurControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getDistributeur(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Distributeur) {
                ...
                return getStringKey(o.getIddistributeur());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Distributeur.class.getName());
            }
        }
